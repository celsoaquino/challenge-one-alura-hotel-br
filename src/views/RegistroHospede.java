...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		txtNacionalidade.setModel(new DefaultComboBoxModel<String>(new String[] { "Selecione...", "alemão", "andorrano",
		...
		lblTitulo.setBounds(606, 55, 254, 42);
		...
		txtNreserva.setText(String.valueOf(ReservasView.idReserva));
	...
	private void save() {
		...
		if (isValidFields()) {
			LocalDate dataNascimento = ConverterDate.dateToLocalDate(txtDataN.getDate());
			String nacionalidade = txtNacionalidade.getSelectedItem().toString();
			Hospede hospede = new Hospede(txtNome.getText(), txtSobrenome.getText(), dataNascimento, nacionalidade,
					txtTelefone.getText(), ReservasView.idReserva);
			this.hospedeController.save(hospede);
			JOptionPane.showMessageDialog(this, "Numero da reserva: " + hospede.getIdReserva(), "Salvo com sucesso!",
					JOptionPane.PLAIN_MESSAGE);
			clearForm();
		} else {
			JOptionPane.showMessageDialog(null, "Todos os campos devem ser preenchidos.", "Campos inválidos!",
	...
	private boolean isValidFields() {
		if (txtNome.getText() == null || txtNome.getText().trim().isEmpty() || txtSobrenome.getText() == null
				|| txtSobrenome.getText().trim().isEmpty() || txtDataN.getDate() == null
				|| txtNacionalidade.getSelectedIndex() == 0 || txtTelefone.getText() == null
				|| txtTelefone.getText().trim().isEmpty() || ReservasView.idReserva == null) {
			return false;
		} else {
			return true;
		}
